  ...
  return (
    <div>
      <Container >
        ...
        <p className="destSubHeading text-center">We keep you informed of the latest news from the vacation world, subscribe to our blog and find out everything.</p>
        <Row>
          <Col xs={12} md={6}>
            <Row className="mt-3">
             ...
             <div>
                ...
                <p className="blogDesc ml-4">We love to see you live an exciting, unique and unforgettable experience.</p>
          ...
          <div  className="blogImage">
             ...
             <div>
                ...
                <p className="blogDesc">We love to see you live an exciting, unique and unforgettable experience.</p>
